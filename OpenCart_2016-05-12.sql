...
# Database: OpenCart
# Generation Time: 2016-05-12 15:18:43 +0000
# ************************************************************
...
# Dump of table oc_affiliate_transaction
# ------------------------------------------------------------
...
INSERT INTO `oc_banner_image` (`banner_image_id`, `banner_id`, `link`, `image`)
VALUES
...
# Dump of table oc_banner_image_description
# ------------------------------------------------------------
...
INSERT INTO `oc_banner_image_description` (`banner_image_id`, `language_id`, `banner_id`, `title`)
VALUES
...
INSERT INTO `oc_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_description`, `meta_keyword`, `seo_title`, `seo_h1`)
VALUES
	(28,1,'Мониторы','','','','',''),
	(33,1,'Камеры','','','','',''),
	(32,1,'Веб-камеры','','','','',''),
...
# Dump of table oc_category_rules
# ------------------------------------------------------------

DROP TABLE IF EXISTS `oc_category_rules`;

CREATE TABLE `oc_category_rules` (
...
LOCK TABLES `oc_category_rules` WRITE;
/*!40000 ALTER TABLE `oc_category_rules` DISABLE KEYS */;

INSERT INTO `oc_category_rules` (`id`, `category_id`, `parent_category_id`, `name`, `second_category_id`)
VALUES
	(2,46,18,'Ноутбуки/Macs,Windows',45),
	(3,26,20,'Компьютеры/PC,Mac',27),
	(4,35,26,'PC/test 1,test 2',36),
	(5,20,0,'/Компьютеры,Ноутбуки',18),
	(6,31,25,'Компоненты/Сканеры,Принтеры',30);

/*!40000 ALTER TABLE `oc_category_rules` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `oc_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format`, `postcode_required`, `status`)
VALUES
...
INSERT INTO `oc_coupon` (`coupon_id`, `name`, `code`, `type`, `discount`, `logged`, `shipping`, `total`, `date_start`, `date_end`, `uses_total`, `uses_customer`, `status`, `date_added`)
VALUES
...
VALUES
	(1,'Рубль','RUB','',' р.','2',65.29599762,1,'2016-05-12 21:12:19'),
	(2,'US Dollar','USD','$','','2',1.00000000,1,'2016-05-12 21:14:59'),
	(3,'Euro','EUR','','€','2',0.87709999,1,'2016-05-12 21:12:19');
...
# Dump of table oc_custom_field_to_customer_group
# ------------------------------------------------------------
...
# Dump of table oc_customer_ban_ip
# ------------------------------------------------------------
...
# Dump of table oc_customer_field
# ------------------------------------------------------------
...
INSERT INTO `oc_customer_group` (`customer_group_id`, `approval`, `company_id_display`, `company_id_required`, `tax_id_display`, `tax_id_required`, `sort_order`)
VALUES
	(1,0,1,0,0,1,1);
...
# Dump of table oc_customer_reward
# ------------------------------------------------------------
...
INSERT INTO `oc_geo_zone` (`geo_zone_id`, `name`, `description`, `date_modified`, `date_added`)
VALUES
...
INSERT INTO `oc_information` (`information_id`, `bottom`, `sort_order`, `status`)
VALUES
	(3,1,3,1),
	(4,1,1,1),
	(5,1,4,1),
...
INSERT INTO `oc_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_description`, `meta_keyword`, `seo_title`, `seo_h1`)
VALUES
	(4,1,'О нас','&lt;p&gt;\r\n	О нас&lt;/p&gt;\r\n','','','',''),
...
INSERT INTO `oc_language` (`language_id`, `name`, `code`, `locale`, `image`, `directory`, `filename`, `sort_order`, `status`)
VALUES
...
# Dump of table oc_manufacturer_description
# ------------------------------------------------------------
...
INSERT INTO `oc_manufacturer_description` (`manufacturer_id`, `language_id`, `description`, `meta_description`, `meta_keyword`, `seo_title`, `seo_h1`)
VALUES
	(5,1,'','','','',''),
	(6,1,'','','','',''),
	(7,1,'','','','',''),
...
# Dump of table oc_order_download
# ------------------------------------------------------------
...
VALUES
	...
	(42,'Товар 15','','','','','','','',990,5,'data/demo/apple_cinema_30.jpg',8,1,100.0000,400,9,'2009-02-04',12.50000000,1,1.00000000,2.00000000,3.00000000,1,1,2,0,1,'2009-02-03 21:07:37','2011-09-30 00:46:19',0),
	(43,'Товар 16','','','','','','','',929,5,'data/demo/macbook_1.jpg',8,0,500.0000,0,9,'2009-02-03',0.00000000,1,0.00000000,0.00000000,0.00000000,2,1,1,0,1,'2009-02-03 21:07:49','2011-09-30 01:05:46',0),
	...
	(46,'Товар 19','','','','','','','',1000,5,'data/demo/sony_vaio_1.jpg',10,1,1000.0000,0,9,'2009-02-03',0.00000000,1,0.00000000,0.00000000,0.00000000,2,1,1,0,1,'2009-02-03 21:08:29','2011-09-30 01:06:39',0),
	(47,'Товар 21','','','','','','','',1000,5,'data/demo/hp_1.jpg',7,1,100.0000,400,9,'2009-02-03',1.00000000,1,0.00000000,0.00000000,0.00000000,1,0,1,0,1,'2009-02-03 21:08:40','2011-09-30 01:05:28',0),
...
INSERT INTO `oc_product_option` (`product_option_id`, `product_id`, `option_id`, `option_value`, `required`)
VALUES
	(224,35,11,'',1),
...
# Dump of table oc_product_reward
# ------------------------------------------------------------
...
INSERT INTO `oc_setting` (`setting_id`, `store_id`, `group`, `key`, `value`, `serialized`)
VALUES
	...
	(135,0,'config','config_encryption','503529c2e810afb33cb4ee503e3a46c8',0),
	...
	(133,0,'config','config_email','webdev56rus@mail.ru',0),
	...
	(134,0,'config','config_url','http://opencart.domain/',0);
...
INSERT INTO `oc_url_alias` (`url_alias_id`, `query`, `keyword`)
VALUES
...
INSERT INTO `oc_user` (`user_id`, `user_group_id`, `username`, `password`, `salt`, `firstname`, `lastname`, `email`, `code`, `ip`, `status`, `date_added`)
VALUES
	(1,1,'admin','bae913a536e4f98adc678e9d2c27fb4d94a1c6bc','ad64e8449','','','webdev56rus@mail.ru','','192.168.0.66',1,'2016-05-12 20:11:41');
...
INSERT INTO `oc_voucher_theme` (`voucher_theme_id`, `image`)
VALUES
...
INSERT INTO `oc_voucher_theme_description` (`voucher_theme_id`, `language_id`, `name`)
VALUES
	(6,1,'Рождество'),
	(7,1,'День рождения'),
	(8,1,'Основной'),
